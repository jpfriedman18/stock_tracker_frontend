...
/***/ function(module, exports, __webpack_require__) {
	...
	$(document).ready(function () {
	  ...
	  var displayStockPurchases = function displayStockPurchases(stock_purchases) {
	    var stockPurchaseListingTemplate = __webpack_require__(13);
	    $('.stocks').html(stockPurchaseListingTemplate({ stock_purchases: stock_purchases }));
	  };

	  var createCollapseAlert = function createCollapseAlert() {
	  ...
	  var showStocks = function showStocks() {
	    $.ajax({
	  ...
	  $('.stocks').on('click', '.update-stock', function (e) {
	    var id = $(e.target).attr("data-stock-id");
	  ...
	  $('#update-stock').on('submit', function (e) {
	    e.preventDefault();
	    var id = $('.update-stock-btn').attr('data-stock-id');
	    var formData = new FormData(e.target);
	    $.ajax({
	  ...
	  var calculatePortfolioGainLoss = function calculatePortfolioGainLoss() {
	    myApp.stockPurchases.forEach(calculateIndividualGainLoss);
	  };

	  var calculateIndividualGainLoss = function calculateIndividualGainLoss(stock) {
	  ...
	  var normalizeDollars = function normalizeDollars(stock) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "  <tr>\n"
	    + ((stack1 = container.invokePartial(__webpack_require__(33),depth0,{"name":"stock_purchase","data":data,"indent":"    ","helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "")
	    + "  </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return "<tr class=\"table-top-row\">\n  <td>Ticker</td>\n  <td>Company</td>\n  <td>Shares Purchased</td>\n  <td>Purchase Price</td>\n  <td>Current Price</td>\n  <td>Gain/Loss</td>\n</tr>\n\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.stock_purchases : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<td>"
	    + alias4(((helper = (helper = helpers.ticker || (depth0 != null ? depth0.ticker : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"ticker","hash":{},"data":data}) : helper)))
	    + "</td>\n<td>"
	    + alias4(((helper = (helper = helpers.name || (depth0 != null ? depth0.name : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"name","hash":{},"data":data}) : helper)))
	    + "</td>\n<td>"
	    + alias4(((helper = (helper = helpers.shares_purchased || (depth0 != null ? depth0.shares_purchased : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"shares_purchased","hash":{},"data":data}) : helper)))
	    + "</td>\n<td>$"
	    + alias4(((helper = (helper = helpers.purchase_price || (depth0 != null ? depth0.purchase_price : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"purchase_price","hash":{},"data":data}) : helper)))
	    + "</td>\n<td>$"
	    ...
	    + "</td>\n<td class=\"gain-loss\">$"
	    + alias4(((helper = (helper = helpers.gainLoss || (depth0 != null ? depth0.gainLoss : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"gainLoss","hash":{},"data":data}) : helper)))
	    + "</td>\n<td><button type=\"button\" class=\"btn btn-primary update-stock\" data-stock-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\" data-toggle=\"modal\" data-target=\".update-stock-modal\">Update</button></td>\n<td><button type=\"button\" class=\"btn btn-danger delete-stock\" data-stock-id=\""
	    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
	    + "\">Delete</button></td>\n";
	},"useData":true});
